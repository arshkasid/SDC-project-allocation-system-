...
<body>
<div class="container-fluid" style=" border:8px; margin-top:20px; margin-bottom:20px; width: 800px; border-radius: 30px; opacity: 0.8; background:white; box-shadow: 2px 4px 8px 8px rgba(0, 0, 0, 0.1);">
