...
<h2 class="text-center m-4 mt-5 pt-3">Teacher On Leave </h2>
 ...
 <select name="facultyId" id="" class="form-select">
                    <option value="">facultyId </option>
                    <?php
                        $select_row="Select * from `faculty`";
                        $result_row=mysqli_query($con,$select_row);
                        while($row_data=mysqli_fetch_assoc($result_row)){
                            $name=$row_data['name'];
                            $facultyId=$row_data['facultyId'];
                            echo "<option value='$facultyId'>$facultyId &nbsp $name</option>";
                        }
                    ?>
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="text" id="remarks" class="form-control" placeholder="Enter  remarks" autocomplete="off" required="required" name="remarks">
                </div>
...
if(isset($_POST['user_register'])) {
    ...
    $insert_query="insert into `tol` (facultyId,addedBy,remarks) values ('$facultyId','$adminId','$remarks')";
